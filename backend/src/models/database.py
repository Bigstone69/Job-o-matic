...
from sqlalchemy import String, Text, Integer, DateTime, Enum, JSON, ForeignKey, Index
...
class Job(Base):
    ...
    requirements_parsed: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
    # Structure: {
